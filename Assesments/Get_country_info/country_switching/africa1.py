...
north_african_countries = ["algeria", "egypt", "libya", "morocco", "sudan", "tunisia"]

# List of West African countries
west_african_countries = ["benin", "burkina faso", "cape verde", "cote d'ivoire", "gambia", "ghana", 
                           "guinea", "guinea-bissau", "liberia", "mali", "mauritania", "niger", "nigeria", 
                           "senegal", "sierra leone", "togo"]

# List of Central African countries
central_african_countries = ["angola", "cameroon", "central african republic", "chad", "congo", 
                              "democratic republic of the congo", "equatorial guinea", "gabon", "sao tome and principe"]

# List of East African countries
east_african_countries = ["burundi", "comoros", "djibouti", "eritrea", "ethiopia", "kenya", "madagascar", 
...
southern_african_countries = ["botswana", "eswatini", "lesotho", "namibia", "south africa"]

def switch_country(continent, region, country):
    if region.lower() in north_african_countries:
        if country.lower() == "algeria" or country.lower() == "dz":
            url = DZ()
            return url
    ...
    # Add more West African countries similarly...
        elif region.lower() in west_african_countries:
            if country.lower() == "benin" or country.lower() == "bj":
                url = BJ()
                return url
            elif country.lower() == "burkina faso" or country.lower() == "bf":
                url = BF()
                return url
            elif country.lower() == "cape verde" or country.lower() == "cv":
                url = CV()
                return url
            elif country.lower() == "cote d'ivoire" or country.lower() == "ci":
                url = CI()
                return url
...
# Add more Central African countries similarly...
        elif region.lower() in central_african_countries:
            if country.lower() == "angola" or country.lower() == "ao":
                url = AO()
                return url
                ...
                url = TD()
                return url
            elif country.lower() == "congo" or country.lower() == "cg":
                url = CG()
                return url
...
# Add more East African countries similarly...
        elif region.lower() in east_african_countries:
            if country.lower() == "burundi" or country.lower() == "bi":
                url = BI()
                return url
...
# Add more Southern African countries similarly...
        elif region.lower() in southern_african_countries:
            if country.lower() == "botswana" or country.lower() == "bw":
                url = BW()
                return url
...
# Handle countries not in any region
        else:
...
def US():
    url = functions.load_url("Assesments/Get_country_info/country_urls/US_details.txt")
    return url